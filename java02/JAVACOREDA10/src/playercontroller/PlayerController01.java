...
public class PlayerController01 {
	...
	public List<Player01> sortBySalary(List<Player01> list) {
		Collections.sort(list, new Comparator<Player01>() {

			public int compare(Player01 salary01, Player01 salary02) {
				return (int) (salary01.getSalary() - salary02.getSalary());
			}
		});
		return list;
	}
